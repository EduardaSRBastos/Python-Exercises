# -*- coding: utf-8 -*-
"""
Created on Mon Mar 28 17:28:49 2022
...
netflix_titles = pd.read_csv("C:/uni/Intro Ciencia Dados/netflix_titles.csv")
...
titanic_train = pd.read_csv("C:/uni/Intro Ciencia Dados/train.csv")
...
exam_data = pd.read_csv("C:/uni/Intro Ciencia Dados/StudentsPerformance.csv")
