...
train = df[df.index < pd.to_datetime("2021-10-01", format='%Y-%m-%d')]
test = df[df.index > pd.to_datetime("2021-10-01", format='%Y-%m-%d')]
...
SARIMAXmodel = SARIMAX(y, order = (1, 2, 1))
...
#ver o erro entre o número de casos e a previsão 158608
